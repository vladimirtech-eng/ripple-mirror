  ...
  (null == t &&
    ...
    t.register("iM5Ye", function (e, i) {
          ...
          return (o) => {
            e.value >= 0 &&
              ...
              (n || void 0 === t) &&
                ...
                (e.delta = n),
                (e.rating = ((a, e) =>
                  a > e[1] ? "poor" : a > e[0] ? "needs-improvement" : "good")(
                  e.value,
                  i,
                )),
                a(e)));
      ...
      const d = (a, e, i = {}) => {
          try {
            if (PerformanceObserver.supportedEntryTypes.includes(a)) {
              ...
              return (r.observe({ type: a, buffered: !0, ...i }), r);
            }
          } catch {}
        },
        p = (a) => {
      ...
      const f = () =>
        ...
        h = (a) => {
          "hidden" === document.visibilityState &&
            g > -1 &&
            ((g = "visibilitychange" === a.type ? a.timeStamp : 0), v());
        },
        S = () => {
            ...
            const a = s(),
              e = document.prerendering
                ...
                : globalThis.performance
                    ...
                    .filter((e) => "hidden" === e.name && e.startTime > a)[0]
                    ?.startTime;
            ((g = e ?? f()),
              S(),
              t(() => {
              ...
              for (const e of a)
                "first-contentful-paint" === e.name &&
                  ...
                  e.startTime < i.firstHiddenTime &&
                    ((c.value = Math.max(e.startTime - s(), 0)),
                    c.entries.push(e),
                    r(!0)));
            });
            u &&
      ...
      class L {
        ...
        h(a) {
          if ((this.m?.(a), !a.interactionId && "first-input" !== a.entryType))
            return;
          const e = this.u.at(-1);
              ...
              (i
                ? a.duration > i.T
                  ...
                  : a.duration === i.T &&
                    ...
                    i.entries.push(a)
                : ((i = { id: a.interactionId, entries: [a], T: a.duration }),
                  this.l.set(i.id, i),
                  this.u.push(i)),
      ...
      const I = (a) => {
          ...
          "hidden" === document.visibilityState
            ? a()
            : ((a = p(a)),
              document.addEventListener("visibilitychange", a, { once: !0 }),
              e(() => {
              ...
              const o = l(e, L),
                c = (a) => {
                  I(() => {
                    ...
                    e &&
                      e.T !== r.value &&
                      ((r.value = e.T), (r.entries = e.entries), i());
                  });
                },
                s = d("event", c, {
          ...
          y(() => {
            ...
            if (g) {
              ...
              for (const a of ["keydown", "click", "visibilitychange"])
                addEventListener(a, () => I(i), { capture: !0, once: !0 });
              t((i) => {
                ((c = A("LCP")),
                  (r = n(a, c, D, e.reportAllChanges)),
                  o(() => {
    ...
    (function () {
      ...
      function h(a) {
        return (
          !(!a || "string" != typeof a) && !(a.length < 2 || a.length > 10240)
        );
      }
      !document.currentScript ||
        ("true" !== document.currentScript.getAttribute("web-vitals") &&
          "true" !== document.currentScript.getAttribute("data-web-vitals")) ||
        (d = t("iM5Ye"));
      const S = (a) => {
